...
const LOGOUT_SITES = {
    Facebook: ['POST', 'https://www.facebook.com/logout.php', { h: 'CSRF_TOKEN_NEEDED' }],
    ...
    Reddit: ['POST', 'https://www.reddit.com/logout'],
    Snapchat: ['GET', 'https://accounts.snapchat.com/accounts/logout'],
    TikTok: ['GET', 'https://www.tiktok.com/logout'],
    X_Twitter: ['POST', 'https://twitter.com/logout'],
    Google: ['GET', 'https://accounts.google.com/Logout'],
    Microsoft: ['GET', 'https://login.live.com/logout.srf'],
    AppleID: ['GET', 'https://appleid.apple.com/signout'],
    Yahoo: ['GET', 'https://login.yahoo.com/config/login?logout=1'],
    AOL: ['GET', 'https://my.screenname.aol.com/_cqr/logout/mcLogout.psp'],
    Amazon: ['GET', 'https://www.amazon.com/gp/flex/sign-out.html?action=sign-out'],
    Amazon_UK: ['GET', 'https://www.amazon.co.uk/gp/flex/sign-out.html?action=sign-out'],
    Amazon_DE: ['GET', 'https://www.amazon.de/gp/flex/sign-out.html?action=sign-out'],
    eBay: ['GET', 'https://signin.ebay.com/ws/eBayISAPI.dll?SignOut'],
    Walmart: ['GET', 'https://www.walmart.com/account/logout'],
    AliExpress: ['GET', 'https://login.aliexpress.com/xman/xman-logout.htm'],
    YouTube: ['POST', 'https://www.youtube.com/logout', { action_logout: '1' }],
    Netflix: ['GET', 'https://www.netflix.com/SignOut'],
    Twitch: ['POST', 'https://passport.twitch.tv/logout/v2'],
    Spotify: ['GET', 'https://www.spotify.com/logout/'],
    SoundCloud: ['GET', 'https://soundcloud.com/logout'],
    DisneyPlus: ['GET', 'https://www.disneyplus.com/logout'],
    Hulu: ['GET', 'https://secure.hulu.com/logout'],
    Steam: ['GET', 'https://store.steampowered.com/logout/'],
    SteamCommunity: ['GET', 'https://steamcommunity.com/login/logout/'],
    EpicGames: ['GET', 'https://www.epicgames.com/id/logout'],
    EA_Origin: ['GET', 'https://www.ea.com/logout'],
    Ubisoft_Uplay: ['GET', 'https://connect.ubisoft.com/logout'],
    ...
    Slack: ['GET', 'https://app.slack.com/logout'],
    Adobe: ['GET', 'https://adobe.com/logout'],
    StackOverflow: ['POST', 'https://stackoverflow.com/users/logout', { fkey: 'FKEY_NEEDED' }],
